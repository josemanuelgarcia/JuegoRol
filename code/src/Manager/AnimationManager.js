...
},addAnimationsLink:function(link)
{
 this.objectToBeAnimated = link;
  //Animacion Simple Arriba
     ...
     this.objectToBeAnimated.animaciones["ESPADA_ARRIBA"]  = new cc.Sequence(new cc.Animate(animacionEspArriba),cc.CallFunc.create(link.lock, link));
     ...
     this.objectToBeAnimated.animaciones["ESPADA_ABAJO"]  = new cc.Sequence(new cc.Animate(animacionEspAbajo),cc.CallFunc.create(link.lock, link));
     ...
     this.objectToBeAnimated.animaciones["ESPADA_DERECHA"]  = new cc.Sequence(new cc.Animate(animacionEspDerecha),cc.CallFunc.create(link.lock, link));
     this.objectToBeAnimated.animaciones["ESPADA_IZQUIERDA"]  = new cc.Sequence(new cc.Animate(animacionEspDerecha),cc.CallFunc.create(link.lock, link));

      var framesCaminarAbajo = this.getAnimacion("link_rodar_abajo", 8);
      var animacionAbajo = new cc.Animation(framesCaminarAbajo, 0.05);
      this.objectToBeAnimated.animaciones["RODAR_ABAJO"] = new cc.Sequence(new cc.Animate(animacionAbajo),cc.CallFunc.create(link.lock, link));
      //Animacion Caminar Arriba
      var framesCaminarArriba = this.getAnimacion("link_rodar_arriba", 8);
      var animacionArriba = new cc.Animation(framesCaminarArriba, 0.05);
      this.objectToBeAnimated.animaciones["RODAR_ARRIBA"] =new cc.Sequence(new cc.Animate(animacionArriba),cc.CallFunc.create(link.lock, link));
      //Animacion Caminar Derecha
      var framesCaminarDerecha = this.getAnimacion("link_rodar_derecha", 8);
      var animacionDerecha = new cc.Animation(framesCaminarDerecha, 0.05);
      this.objectToBeAnimated.animaciones["RODAR_DERECHA"] =new cc.Sequence(new cc.Animate(animacionDerecha),cc.CallFunc.create(link.lock, link));
      this.objectToBeAnimated.animaciones["RODAR_IZQUIERDA"] =new cc.Sequence(new cc.Animate(animacionDerecha),cc.CallFunc.create(link.lock, link));
 }
